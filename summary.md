...
- [If, Wish, and Conditionals](#if-wish-and-conditionals)
...
- [Verb Complementation](#verb-complementation)
...
- [Articles and Nouns](#articles-and-nouns)
  ...
  - [Possessive Form of Nouns](#possessive-form-of-nouns)
- [Pronouns and Determiners](#pronouns-and-determiners)
  - [Pronouns](#pronouns)
  - [Determiners](#determiners)
  - [Little / Few / Less / Fewer](#little--few--less--fewer)
  - [Some and Any](#some-and-any)
  - [Quantifiers with and without 'of'](#quantifiers-with-and-without-of)
  - [No, None, Neither, Either](#no-none-neither-either)
  - [Much, Many, A Lot Of](#much-many-a-lot-of)
  - [All, Each, Every](#all-each-every)
...
- [Adjectives and Adverbs](#adjectives-and-adverbs)
  ...
  - [Gradable and Non-Gradable Adjectives](#gradable-and-non-gradable-adjectives)
  - [Easily Confused Adjectives (-ed vs. -ing)](#easily-confused-adjectives--ed-vs--ing)
  - [Quite: Two Meanings](#quite-two-meanings)
  - [Adverb Types](#adverb-types)
...
- [Conjunctions](#conjunctions)
  - [Although / Despite / In Spite Of](#although--despite--in-spite-of)
  - [Tenses in Adverbial and Main Clauses](#tenses-in-adverbial-and-main-clauses)
  - [Time Clauses: Tenses](#time-clauses-tenses)
...
| **Negative prefixes** | `un-`, `in-`/`im-`/`il-`/`ir-`, `dis-`, `non-`, `mis-`, `anti-`, `counter-` |
...
| Drop *-e* before *-ing* | *hope -> hoping* (but: *be -> being*, *see -> seeing*) |
| Keep *-e* before *-ed* | *hope -> hoped* |
| Double final consonant (stressed, CVC) | *stop -> stopping, begin -> beginning* |
| No doubling (unstressed or two consonants) | *visit -> visiting, help -> helping* |
| BrE doubles *l* | *travelling* (AmE: *traveling*) |
...
| Seasons = lowercase | *spring, summer* (unless in a title) |
| *I* always capitalized | *My friend and I* |
...
| Both objects are pronouns | *Give it to me.* (NOT *Give me it*) |
...
| *if only + would* | Future frustration | *If only you would listen.* |
| *it's (high/about) time + past simple* | Overdue action | *It's time you left.* |
| *would rather + V1* | Same-subject preference | *I'd rather stay home.* |
| *would rather + different subj. + past simple* | Present/future preference | *I'd rather you didn't smoke.* |
| *would rather + different subj. + past perfect* | Past regret about others | *I'd rather you hadn't told him.* |
| *as if / as though + past simple* | Present unreal appearance | *He talks as if he knew everything.* |
| *as if / as though + past perfect* | Past unreal appearance | *She looked as if she had seen a ghost.* |
| *what if + present simple* | Future possibility | *What if it rains?* |
| *what if + past simple* | Present imagined | *What if I told you the truth?* |
| *what if + past perfect* | Past hypothetical | *What if I had missed the train?* |
...
| **Negative Subjunctive** | *not* + base verb | *I suggest that he **not go**.* |
| | (NOT *don't/doesn't/didn't*) | *It is essential that she **not be** late.* |
...
> **Formula:** *verb / adj / noun + that + subject + BASE VERB*

> **BrE alternative:** *should* + base verb. *I suggest that he **should go**.*
...
| **Modal Perfect Passive** | *modal + have + been + V3* | *It should have been done.* |
| **Causative (have something done)** | *have/had + object + V3* | *I had my hair cut.* |
| **Impersonal (It is said...)** | *It + passive + that-clause* | *It is said that he is rich.* |
...
| Use | Example |
|-----|---------|
| Emphasis | *I **do** like it! / She **did** call you.* |
...
| *So + adj/adv + that* | *So tired was he that he fell asleep.* |
| *Such + be + that* | *Such was the force that windows shattered.* |
...
| Structure | Example |
|-----------|---------|
| *May + S + V* | *May you be happy! / May you have a long life!* |
...
| **Reversed Wh-cleft** | *[Focus] + be + wh-clause* | *A holiday is what I need.* / *Rest is what I need.* |
| **All-cleft** | *All + clause + be + [focus]* | *All I need is rest.* |
| **Emphatic *do*** | *Subject + do/does/did + base verb* | *I do like it!* |
| **Emphatic *it* (w/o cleft)** | *It + be + adj/noun + to-infinitive/that-clause* | *It is a pleasure to meet you.* |
...
| **Wh-Question** (wh = subject) | *Wh-word + main verb?* | *Who called? / What happened?* (No *do* used; but *do* can be added for emphasis, e.g., *'Come on, be honest - who did tell you?'*) |
| **Embedded (Indirect)** | *Intro + wh-word + subject + verb* | *Can you tell me where the station is?* |
| **Tag (positive statement)** | *Positive + negative tag?* | *You like coffee, don't you?* |
| **Tag (negative statement)** | *Negative + positive tag?* | *She isn't here, is she?* |
| **Tag (*I'm*)** | *I'm... + aren't I?* | *I'm late, aren't I?* |
| **Tag (*Let's*)** | *Let's... + shall we?* | *Let's go, shall we?* |
| **Tag (imperative)** | *Imperative + will you?* | *Open the door, will you?* |
| **Echo** (surprise) | *Repeat speaker's words + rising intonation* | *"I'm moving to Japan." - "You're moving to Japan?"* |
| **Echo with Wh-word** | *Wh-word replaces unclear element* | *"I met someone." - "You met who?"* |
| ***That*-clause question** | *How/Why is it that + clause?* | *How is it that you arrived so late?* |
...
| ***No* + noun** | *no* before noun (determiner) | *I have no money.* |
| ***Never*** | *never* before main verb | *I never lie.* |
| ***Neither... nor...*** | two negative elements | *He neither called nor wrote.* |
| **Negative question** | *aux + n't + subject...* | *Don't you like it?* |
| **Negative command** | *Do not / Don't + V1* | *Don't go there.* |
| **Semi-negatives** | *hardly, barely, scarcely, rarely, seldom* | *I hardly know her.* (NOT *I don't hardly*) |
| ***Any* words** | After negative verb -> *any, anything, anyone* | *I don't have any money.* |

> **Double negatives are incorrect in standard English.** *I don't have no money.* ✗ -> *I don't have any money.* ✓
...
> **Punctuation:** Strong emotion -> `!` / Mild emotion -> `,`
...
| *regret* | sorry about past (*regret telling*) | sorry to announce (*regret to inform*) |
| *try* | experiment (*try pressing*) | make an effort (*try to fix*) |
...
| *there's no point in + -ing* | *There's no point in worrying.* |
| *it's no use + -ing* | *It's no use complaining.* |
| *to + V1* (purpose) | *I came to help.* |
| *for + -ing* (object's purpose) | *This is a tool for cutting.* |
| *so that + clause* (with modal) | *Speak clearly so that everyone can understand.* |
| *afraid to do* | Fear of the action itself: *afraid to climb the ladder* |
| *afraid of doing* | Fear of the result: *afraid of falling* |
| *see/hear + obj + V1* | Complete action: *I saw him leave.* |
| *see/hear + obj + -ing* | Action in progress: *I saw him leaving.* |
| **Participial phrase (active)** | *The man standing there is my uncle.* |
| **Participial phrase (passive)** | *The car parked outside is mine.* |
| **Ditransitive: two objects** | *She gave me a book. / She gave a book to me.* |
| **Ditransitive passive (IO subject)** | *I was given a book.* |
| **Ditransitive passive (DO subject)** | *A book was given to me.* |
...
| **Verb + to-infinitive or -ing (different meaning)** | *come, go on, mean, regret, remember, stop, try* | *She came hurrying up the path. / How did you come to buy the car?* |
| **Verb + object + to-infinitive** (must have object) | *allow, believe, cause, command, consider, enable, encourage, entitle, force, invite, order, persuade, show, teach, tell, warn* | *My parents wouldn't allow me to go to the party.* |
| **Verb + (object) + to-infinitive** (object optional) | *hate, help, like, love, need, prefer, want, wish* | *I would hate (her) to give the job up.* |
| **Verb + object + -ing** (must have object) | *catch, discover, feel, find, hear, leave, notice, observe, overhear, see, spot* | *The police caught him driving without a licence.* |
| **Verb + (object) + -ing** (object optional) | *detest, dislike, dread, envisage, hate, imagine, like, love, mind (Q/N), miss, recall, regret, remember, resent, risk, start, stop* | *I can't stand (him) wearing a suit.* |
| **Verb + object + bare infinitive or -ing** (sometimes meaning difference) | *feel, hear, notice, observe, overhear, see, watch* | *She felt the mosquito bite / biting her.* |
...
| **Clausal (Answer)** | Essential info only | *"Where are you going?" - "To the store."* |
| **Comparative** | *than/as... as + reduced clause* | *She is taller than I __.* |
| **Gapping** | Verb omitted in 2nd clause | *John eats rice, and Mary __ beans.* |
| **Stripping** | One word/phrase + *too/either* | *John likes pizza, and Mary too.* |
...
| **Nouns: plural form but singular meaning** | *news, mathematics, physics, measles* (singular verb) |
| **Nouns: always plural** | *scissors, trousers, jeans, glasses, clothes* (plural verb) |
...
| **Indefinite** (people) | *someone, anyone, no one, everyone* |
| **Indefinite** (things) | *something, anything, nothing, everything* |
| **Dummy** | *there* (existence), *it* (weather/time/general) |
...
| **Demonstrative** | *this, that, these, those* |
| **Quantifiers** (positive) | *some, a lot of, plenty of* |
| **Quantifiers** (neg/Q) | *any, much, many* |
...
| **Noun** | Subject/Object/Complement | *that, what, who, whoever, when, where, why, how, whether, if* |
| **Participle (Reduced)** | Adjectival/Adverbial | Present participle (*-ing*), Past participle (*-ed*), *to*-infinitive |
| **Cleft** | Emphasis | *It is/was... that/who..., What... is/was..., All... is/was...* |
...
| *Which* = whole clause | *He was late, which surprised everyone.* |
...
| Long (2+ syllables) | *more + adj* | *most + adj* |
| Irregular | *good -> better* | *good -> best* |
...
| **Adjectives as nouns** (groups) | *the rich, the poor, the unemployed* |
| **Compound adjectives** (hyphenated before noun) | *a fast-moving train, a five-year-old boy* |
...
| **Place** | *here, outside* | End |
| **Certainty** | *probably, definitely* | Mid (before main verb, after aux) |
| **Viewpoint** | *personally, technically* | Front |
| **Focusing** | *only, even, especially* | Before focused word |
...
> Use an adverb, not an adjective, to say how something happened or was done, or to modify adjectives. Examples: *The staff in the shop always speak politely to customers. / It was strangely quiet as we went into the room.*
...
| **Negative Equality** | *not as/so + adj/adv + as* |
| **Inequality** | *less + adj/adv + than* |
| **Proportional** | *the + comparative..., the + comparative...* |
| **Repeated** | *comparative and comparative* (*colder and colder*) |
...
| *Like* / *Unlike* | *Like his father, he is a doctor. / Unlike her sister, she loves coffee.* |
...
| Sequencing | *first, second, next, then, after that, finally* |
| Opinion | *in my opinion, I think, personally, to be honest* |
| Certainty | *certainly, definitely, undoubtedly, of course* |
| Doubt | *perhaps, maybe, probably, possibly* |
| Clarifying | *in other words, that is, namely, i.e.* |
...
| *during* | within a period (*during the movie*) |
| *before/after* | earlier/later than |
| *until/till* | up to a point |
| *by* | deadline; not later than |
| *on time* | punctual |
| *in time* | with enough time to spare |
| *at the end of* | the final part |
| *in the end* | finally |
...
| *for* | wait, look, ask, hope, search, apply, care, pay |
| *of* | hear, dream, think, consist, approve, die |
| *from* | hear, come, suffer, protect, recover, differ |
| *on* | depend, work, comment, focus, rely, insist |
| *in* | believe, succeed, result, participate, invest |
...
| *off* | *turn off, take off, get off, put off, go off* |
| *in* | *give in, log in, take in* |
| *out* | *find out, go out, work out, figure out, point out* |
| *away* | *throw away, go away, put away, take away* |
| *back* | *come back, give back, take back, get back, put back* |
...
| *neither... nor...* | *neither rich nor famous* |
| *not only... but also...* | *not only sings but also dances* |
| *than / as* comparisons | *as tall as his brother* |
...
| Slang/Idioms | Never | Rare | Common |
...
| **Adjectives** | *possible, probable, likely, unlikely, doubtful* |
| **Nouns** | *possibility, probability, likelihood, tendency* |
| **Approximators** | *about, around, sort of, kind of, a little, a bit* |
...
| *in the case of* | regarding | *...in the case of elderly patients* |
| *irrespective of* | regardless of | *...irrespective of age or gender* |
