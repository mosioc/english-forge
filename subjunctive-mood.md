...
### A. What Is the Subjunctive Mood?

The subjunctive is a **verb form** that is used in certain grammatical contexts. In English, the subjunctive is most noticeable in the **present subjunctive** (which uses the base form of the verb) and the **past subjunctive** (which uses *were* for all persons).
...
The present subjunctive uses the **base form (V1)** of the verb for **all persons** (including *he, she, it*). It does **not** add `-s` in the third person singular.

#### 1. Formation

| Verb | Indicative (He/She/It) | Subjunctive (All Persons) |
|------|------------------------|---------------------------|
| *be* | *he is* | *that he **be*** |
...
| Example | Meaning |
|---------|---------|
| *I suggest that he **go** to the doctor.* | (Not: *he goes*) |
...
Certain fixed expressions use the present subjunctive and have survived from older English.

| Expression | Meaning |
|------------|---------|
| *God **save** the King/Queen!* | Long live the King/Queen |
| *Heaven **forbid**!* | May it not happen |
...
### C. Past Subjunctive (*Were* Subjunctive)

The past subjunctive is used for hypothetical, unreal, or contrary-to-fact situations. Its distinctive feature is the use of **were** for **all persons** (instead of *was*).

#### 1. Formation

| Person | Indicative (Past) | Subjunctive (Past) |
|--------|-------------------|---------------------|
| *I* | *I was* | *if I **were*** |
| *you* | *you were* | *if you **were*** |
| *he/she/it* | *he was* | *if he **were*** |
| *we* | *we were* | *if we **were*** |
| *they* | *they were* | *if they **were*** |

#### 2. Uses of the Past Subjunctive

##### A. In *If* Clauses (Hypothetical / Unreal Present)
...
### D. Subjunctive vs. Indicative (Common Confusions)

| Incorrect (Indicative used instead of Subjunctive) | Correct (Subjunctive) |
|----------------------------------------------------|------------------------|
| *I suggest that he **goes** to the doctor.* | *I suggest that he **go** to the doctor.* |
| *She insisted that he **is** present.* | *She insisted that he **be** present.* |
...
### E. Subjunctive vs. *Should* (British English Alternative)

In British English, the subjunctive is often replaced by **should + base verb**, especially in formal contexts.

| Subjunctive (US / Formal) | *Should* Alternative (UK / Common) |
|---------------------------|-------------------------------------|
...
### F. Subjunctive in That-Clauses (Summary Table)
...
| Type | Verb Form | Example |
|------|-----------|---------|
| **Present Subjunctive** | Base form (V1) for all persons | *I insist that he **go**.* / *She demanded that he **be** here.* |
| **Past Subjunctive** | *were* for all persons | *If I **were** you...* / *I wish she **were** here.* |
| **Formulaic Subjunctive** | Base form in fixed expressions | *God **save** the King.* / ***Be** that as it may.* |

---

### H. Common Verbs That Trigger the Subjunctive

| Verb | Example |
|------|---------|
| *suggest* | *I suggest that he **study** harder.* |
| *insist* | *She insisted that he **be** on time.* |
| *recommend* | *They recommended that she **see** a specialist.* |
| *demand* | *The workers demanded that their pay **be** increased.* |
| *request* | *We requested that the meeting **start** earlier.* |
| *propose* | *He proposed that the company **hire** more staff.* |
| *ask* | *She asked that he **not** reveal the secret.* |
...
### I. Subjunctive in Negative Form

To form the negative subjunctive, add **not** before the base verb.

| Affirmative Subjunctive | Negative Subjunctive |
|-------------------------|----------------------|
...
### J. Subjunctive in Passive Voice

The passive subjunctive is formed with **be + past participle (V3)**.

| Active Subjunctive | Passive Subjunctive |
|--------------------|---------------------|
...
| Mood | Use | Example |
|------|-----|---------|
| **Indicative** | States facts | *He **is** tired.* / *She **goes** to school.* |
| **Imperative** | Gives commands | ***Be** quiet!* / ***Go** to school!* |
| **Subjunctive** | Expresses wishes, demands, hypotheticals | *I insist that he **be** quiet.* / *If I **were** you...* |
